...
export default function CardNegocioPlay({
  ...
  return (
    ...
    >
      <div className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-[22px] border border-gray-200 bg-white shadow-[0_10px_24px_-18px_rgba(15,23,42,0.45)]">
        <img
          src={logoResolvendo}
          alt={`Logo de ${titulo}`}
          loading="lazy"
